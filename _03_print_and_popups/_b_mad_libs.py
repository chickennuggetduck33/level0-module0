...
if __name__ == '__main__':
    ...
    messagebox.showinfo(None, message="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title= 'adjective', prompt= "please enter an adjective")
    # Get the player to enter a type of liquid
    liquid =  simpledialog.askstring(title= 'liquid', prompt= "please enter a liquid")
    ...
    noun = simpledialog.askstring(title= 'noun', prompt= "please enter an improper noun")
